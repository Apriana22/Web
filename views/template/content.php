        ...
        <div class="content-area">
            ...
            <div class="content-area-inner">
                ...
                <section id="intro">
                    ...
                    <div class="container-mid">
                        ...
                        <div class="animation-container animation-fade-down" data-animation-delay="0">
                            ...
                            <h1>I’m Apriana Malinda Tamba,</h1>
                        ...
                        <div class="animation-container animation-fade-left" data-animation-delay="300">
                            ...
                            <p class="subline">Mahasiswa Teknik yang antusias dan bermotivasi tinggi dengan kemampuan kepemimpinan, inisiatif dan mencari tantangan baru. Berpengalaman dalam berbagai organisasi internal maupun eksternal kampus.</p>
                ...
                <section id="about">
                    ...
                    <h3 class="headline scroll-animated-from-right">Tentang Apriana</h3>
                    
                    <p class="scroll-animated-from-right">Saya Apriana Malinda Tamba, Lahir di Medan, 20 April 2001. Saya terlahir dari keluarga yang sederhana dengan Alm Ayah yang pernah berkerja di Pabrik Kelapa Sawit dan Ibu sebagai seorang menggurus rumah tangga. Saya anak kedua dari tiga bersaudara.</p>

                    <p class="scroll-animated-from-right">Saat ini saya berkuliah di Politeknik Kampar melalui jalur beasiswa BPDPKS. Beasiswa ini merupakan jalan terbaik yang Tuhan beri kepada saya sehingga saya masih dapat berkuliah hingga saat ini.</p>
                ...
                <section id="contact">
                    ...
                    <ul class="contact-list">
                        ...
                        <li class="scroll-animated-from-right"><i class="fa fa-mobile" aria-hidden="true"></i>0852 7549 3908</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-envelope-o" aria-hidden="true"></i>aprianamalinda87@gmail.com</li>
